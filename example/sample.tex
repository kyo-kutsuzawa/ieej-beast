...
\authorlist{%
 \authorentry[someone@example.com]{Anonymous Author}{m}{author1}
}
\affiliate[author1]
{Anonymous}
...
\begin{enumerate}
  ...
  \item G. Gr\"atzer: Math into \TeX–A Simple Introduction to \hologo{AmSLaTeX}, Birkh\"auser(1993)
...
\bibliographystyle{../beast/samcon}
